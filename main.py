...
def main():
    ...
    college_player_name = college_player.init_college_player_info()
    college_latest_stats = college_player.scrape_college_stats()
    ...
    if college_latest_stats is not None:
        ...
        if not nba_dna_matches.empty:
            print(f"NBA Player Matches (In Last Decade):")
